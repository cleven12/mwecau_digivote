...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-$fv(2c9i=uh84+@-_)hbnd=%p+m&#xeq=)w^5d-l+&#h^47j*c')
...
# Celery Configuration (using Django database as broker for now)
