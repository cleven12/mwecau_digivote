...
MIDDLEWARE = [
    ...
    'django.contrib.sessions.middleware.SessionMiddleware',  # For admin
    'django.middleware.common.CommonMiddleware',
    'django.contrib.auth.middleware.AuthenticationMiddleware',  # For admin
...
EMAIL_HOST_PASSWORD = 'ipx ihef eocq bceb'  # Gmail App Password
EMAIL_TIMEOUT = 10